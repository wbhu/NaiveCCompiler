...
class CodeDisplay(object):
    ...
    def syntax_highlight(self, pad, lang='naiveC', pos=GUI.INSERT, flag=0):
        """
        highlights syntax
        """
        pad.edit_separator()
    ...
    def open_highlight(self, pad, lang='naiveC'):
        """
    ...
    def indentation(self, pad, linepad, lang='naiveC', *args):
...
class FilesFileMenu(object):
    ...
    def Open(self, app, book, pad, linepad, lang='naiveC'):
        ...
        if 'cpp' in check[-1] or 'naiveC' in check[-1]:
            lang = 'naiveC'
        else:
            lang = 'py'
...
class EditFileMenu(object):
    def undo(self, pad, linepad, lang='naiveC', *argv):
        """
        undo code
        """
        try:
...
class RunFilemenu(object):
    def compile(self, app, pad, outputpad, lang='naiveC', *args):
        """
